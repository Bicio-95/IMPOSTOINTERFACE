...
public class PessoaFisica {
	...
	public PessoaFisica(String nome, String cpf, double totalDeRendimentos,
			double contribuicaoPrevidenciaraOficial) {
		this.nome = nome;
		this.cpf = cpf;
	...
	public PessoaFisica(String nome, String cpf, int idade, int numeroDependetes,
			double totalDeRendimentos, double contribuicaoPrevidenciaraOficial) {
		this.nome = nome;
		this.cpf = cpf;
		this.idade = idade;
